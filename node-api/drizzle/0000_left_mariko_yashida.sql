...
--> statement-breakpoint
ALTER TABLE "analyses" ADD CONSTRAINT "analyses_polygon_id_polygons_id_fk" FOREIGN KEY ("polygon_id") REFERENCES "public"."polygons"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
